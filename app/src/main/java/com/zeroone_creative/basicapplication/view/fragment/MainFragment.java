...
import com.zeroone_creative.basicapplication.view.activity.EtsyGridActivity_;
...
public class MainFragment extends Fragment {
    ...
    @Click(R.id.main_rippleview_pager)
    void movePager() {
        Intent intent = new Intent(getActivity().getApplicationContext(), PagerActivity_.class);
        startActivity(intent);
    }

    @Click(R.id.main_rippleview_etsy)
    void moveEtsy() {
        Intent intent = new Intent(getActivity().getApplicationContext(), EtsyGridActivity_.class);
        startActivity(intent);
    }

    @Click(R.id.main_rippleview_recycler)
    void moveRecycler() {
